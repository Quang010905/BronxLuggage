        ...
        <div class="col-lg-9">
            <div class="row">
                ...
                <div class="col-md-6 pb-4">
                    <div class="d-flex">
                        <form method="get" action="{{ url('shop/search-products-name') }}">
                            @csrf
                            <div class="input-group">
                                <input type="text" class="input-sm form-control" name="name" value="{{ isset($name) ? $name : '' }}" placeholder="Search product name">
