        ...
        <div class="row">
            ...
            <div class="col-lg-3">
                ...
                <ul class="list-unstyled templatemo-accordion">
                    <li class="pb-3">
                        <a class="collapsed h3 text-decoration-none" href="#">
                            Categories
                            <i class="fa fa-fw fa-chevron-circle-down mt-1"></i>
                        </a>
                        <ul class="collapse show list-unstyled pl-3">
                            @foreach($categories as $category)
                            <li class="pl-3"><a class="text-decoration-none" href="{{url('category-product/' .$category->category_id)}}">{{$category->category_name}}</a></li>
                            @endforeach
                        </ul>
                    </li>
                    <li class="pb-3">
                        ...
                        <ul id="collapseTwo" class="collapse list-unstyled pl-3">
                            ...
                            <li class="pl-3"><a class="text-decoration-none" href="{{url('brand-product/'. $brand->brand_id)}}">{{$brand->brand_name}}</a></li>
                            @endforeach
                        </ul>
                    </li>
                </ul>
            ...
            <div class="col-lg-9">
                ...
                <div class="row">
                    @foreach($categories_by_id as $product)
                    <div class="col-md-4">
